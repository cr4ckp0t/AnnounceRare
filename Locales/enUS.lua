...
L["Drill Notifications: %s"] = true
L["Drill announcements have been %s!"] = true
...
L["Rare list has been reset."] = true
L["TomTom Waypoints: %s"] = true
L["TomTom waypoints have been %s!"] = true
...
L["Valid Outputs: %s, %s, %s, %s, %s, %s, %s"] = true
...
L["|cffffff00/rare drill|r - Toggle drill announcements."] = true
...
L["|cffffff00/rare tomtom|r - Toggle TomTom waypoints."] = true
